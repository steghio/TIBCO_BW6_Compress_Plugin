 ...
 * 
 */
public class GZDeflateSignature extends BWActivitySignature {
	...
	*/
    ...
    public XSDElementDeclaration getInputType(final Configuration config) {
        ...
        inputType =  GZDeflateSchema.getInputType(); 
        // begin-custom-code
        // end-custom-code
        return inputType;
    } 
	...
	*/
    ...
    public XSDElementDeclaration getOutputType(final Configuration config) {
        ...
        outPutType =  GZDeflateSchema.getOutputType();
        // begin-custom-code
        // end-custom-code
        return outPutType;
    }
    ...
    public List<XSDElementDeclaration> getFaultTypes(final Configuration config) {
        ...
        faultType =  GZDeflateSchema.getFaultElements();
        // begin-custom-code
        // end-custom-code
		return faultType;
    }
