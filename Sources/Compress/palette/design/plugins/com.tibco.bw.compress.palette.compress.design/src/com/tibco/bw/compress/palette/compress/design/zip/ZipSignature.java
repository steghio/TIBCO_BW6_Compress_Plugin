 ...
 * 
 */
public class ZipSignature extends BWActivitySignature 
{
	...
	*/
    ...
    public XSDElementDeclaration getInputType(final Configuration config) {
        ...
        inputType =  ZipSchema.getInputType(); 
        // begin-custom-code
        // end-custom-code
        return inputType;
    } 
	...
	*/
    ...
    public XSDElementDeclaration getOutputType(final Configuration config) {
        ...
        outPutType =  ZipSchema.getOutputType();
        // begin-custom-code
        // end-custom-code
        return outPutType;
    }
    ...
    public List<XSDElementDeclaration> getFaultTypes(final Configuration config) {
        ...
        faultType =  ZipSchema.getFaultElements();
        // begin-custom-code
        // end-custom-code
		return faultType;
    }
