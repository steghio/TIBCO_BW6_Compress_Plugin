 ...
 * 
 */
public class TarSignature extends BWActivitySignature {
	...
	*/
    ...
    public XSDElementDeclaration getInputType(final Configuration config) {
        ...
        inputType =  TarSchema.getInputType(); 
        // begin-custom-code
        // end-custom-code
        return inputType;
    } 
	...
	*/
    ...
    public XSDElementDeclaration getOutputType(final Configuration config) {
        ...
        outPutType =  TarSchema.getOutputType();
        // begin-custom-code
        // end-custom-code
        return outPutType;
    }
    ...
    public List<XSDElementDeclaration> getFaultTypes(final Configuration config) {
        ...
        faultType =  TarSchema.getFaultElements();
        // begin-custom-code
        // end-custom-code
		return faultType;
    }
