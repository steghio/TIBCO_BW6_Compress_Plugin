 ...
 * 
 */
public class GZInflateSignature extends BWActivitySignature {
	...
	*/
    ...
    public XSDElementDeclaration getInputType(final Configuration config) {
        ...
        inputType =  GZInflateSchema.getInputType(); 
        // begin-custom-code
        // end-custom-code
        return inputType;
    } 
	...
	*/
    ...
    public XSDElementDeclaration getOutputType(final Configuration config) {
        ...
        outPutType =  GZInflateSchema.getOutputType();
        // begin-custom-code
        // end-custom-code
        return outPutType;
    }
    ...
    public List<XSDElementDeclaration> getFaultTypes(final Configuration config) {
        ...
        faultType =  GZInflateSchema.getFaultElements();
        // begin-custom-code
        // end-custom-code
		return faultType;
    }
