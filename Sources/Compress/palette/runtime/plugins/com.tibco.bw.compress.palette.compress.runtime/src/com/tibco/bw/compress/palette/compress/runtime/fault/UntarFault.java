...
public class UntarFault extends CompressActivityBaseException {
	private static final long serialVersionUID = 1L;
	
	@SuppressWarnings("unused")
	private Object data = null;
	
	public <N> UntarFault(ActivityContext<N> activityContext, Integer code,
	...
	public QName getFaultElementQName() {
		return new QName("http://schemas.tibco.com/bw/plugins/Compress/CompressExceptions","UntarFault");
	}
	/**
	 * @generated
	 *
	...
	public <N> void buildFault(ProcessingContext<N> pcx) {
		N UntarFault = this.createFaultMessageElement(pcx);
		//NOT needed since retCode and retMsg are added by default!
		//UntarFault = this.constructErrData(UntarFault, pcx);
		this.setData(UntarFault);
	}
	...
	//NOT needed since retCode and retMsg are added by default!
	/*
	private <N, A> N constructErrData(N UntarFault, ProcessingContext<N> processingContext) {
		...
		NodeFactory<N> noteFactory = mutableModel.getFactory(UntarFault);
		...
		mutableModel.appendChild(UntarFault, retCode);
		...
		mutableModel.appendChild(UntarFault, retMsg);
		//set default value here, please set value by your business
