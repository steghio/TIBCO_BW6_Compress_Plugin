...
public class GZDeflateFault extends CompressActivityBaseException {
	private static final long serialVersionUID = 1L;
	
	@SuppressWarnings("unused")
	private Object data = null;
	
	public <N> GZDeflateFault(ActivityContext<N> activityContext, Integer code,
	...
	public QName getFaultElementQName() {
		return new QName("http://schemas.tibco.com/bw/plugins/Compress/CompressExceptions","GZDeflateFault");
	}
	/**
	 * @generated
	 *
	...
	public <N> void buildFault(ProcessingContext<N> pcx) {
		N GZDeflateFault = this.createFaultMessageElement(pcx);
		//NOT needed since retCode and retMsg are added by default!
		//GZDeflateFault = this.constructErrData(GZDeflateFault, pcx);
		this.setData(GZDeflateFault);
	}
	...
	//NOT needed since retCode and retMsg are added by default!
	/*
	private <N, A> N constructErrData(N GZDeflateFault, ProcessingContext<N> processingContext) {
		...
		NodeFactory<N> noteFactory = mutableModel.getFactory(GZDeflateFault);
		...
		mutableModel.appendChild(GZDeflateFault, retCode);
		...
		mutableModel.appendChild(GZDeflateFault, retMsg);
		//set default value here, please set value by your business
